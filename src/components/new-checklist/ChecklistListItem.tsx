...
export const ChecklistListItem = ({
  ...
  const progress =
    checklist.totalQuestions && checklist.completedQuestions
      ? Math.round((checklist.completedQuestions / checklist.totalQuestions) * 100)
      : 0;

  const originValue: OriginType | undefined = checklist.origin as OriginType;
  ...
  return (
    ...
    >
      ...
      <div className="col-span-2">
        <Badge
          variant={checklist.isTemplate ? "outline" : "default"}
