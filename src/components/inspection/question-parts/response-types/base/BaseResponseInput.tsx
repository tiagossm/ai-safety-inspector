...
export function BaseResponseInput({
  ...
  // Hook para análise de mídia com retry e circuit breaker
  const { analyzing, canRetry, cancelAllAnalysis, getAnalysisStatus, resetAllState, getDebugInfo } = useMediaAnalysis();
